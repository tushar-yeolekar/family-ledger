/*
  ...
  - Added the required column `familyId` to the `Entry` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Entry" ("amount", "createdAt", "id", "number") SELECT "amount", "createdAt", "id", "number" FROM "Entry";
DROP TABLE "Entry";
